        ...
        <table className="w-full table-fixed border-2 border-black">
          <tbody>
            <tr className="bg-blue-500 text-white">
              ...
              <th className="border-2 border-black p-3 font-semibold text-center w-1/4">Balance</th>
            </tr>
            {props.yearlyAmortisationSchedule
              ...
              .map((item) => {
                ...
                return (
                  <tr key={item.year} className={isInflection ? "bg-yellow-200" : "hover:bg-gray-50"}>
